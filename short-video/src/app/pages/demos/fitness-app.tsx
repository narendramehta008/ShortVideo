...
export const FitnessApp: React.FC<IProp> = ({ dark, size }) => {
    return (
        <div>
            <Card flat dark={dark} className="fitness-app-container">
                <Card flat className="fitness-app-wrapper overflow-hidden">
                    ...
                    >
                        {/* 500 */}
                        <H4 style={{ fontWeight: "bold", marginTop: "8px" }}>Program</H4>
                        <div
                            style={{
                                display: "flex",
                                marginTop: "8px",
                            ...
                            <Card
                                elevation={2}
                                dark={dark}
                                style={{ padding: "16px", width: "116px", margin: "16px 10px" }}>
                                <Card
                                    flat
                                    style={{
                                        width: "32px",
                        ...
                        >
                            <Card
                                elevation={2}
                                dark={dark}
                                style={{ padding: "16px", width: "116px", margin: "10px" }}
                            >
                                <Card
                                    flat
                                    style={{
                    ...
                    >
                        ...
                        >
                            <H4 dark={dark} style={{ fontWeight: "bold" }}>
                                Plan list
              </H4>
                            <IconButton
                                size="small"
